                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative aspect-square overflow-hidden bg-brand-aubergine">
                      <img 
                        src={pattern.image} 
                        alt={`${pattern.title} - ${pattern.category} surface pattern design by Snadia Creations`} 
            ...
            >
              ...
              <div className="w-full md:w-1/2 relative bg-brand-dark flex items-center justify-center min-h-[300px] md:min-h-[500px]">
                <img 
                  ...
                  alt={`${selectedItem.title} - ${selectedItem.category} surface pattern design by Snadia Creations`} 
